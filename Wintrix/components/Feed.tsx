...
const IntelligenceCardList: React.FC<IntelligenceCardListProps> = ({ data, handleTagClick }) => {
  return (
    <div className="mt-16 flex-wrap overflow-x-auto flex flex-row gap-3 sm:px-6 md:-max-w-xl lg:px-8 max-w-screen-md">
...
const Feed: React.FC<FeedProps> = ({ data }) => { // Type Feed component props
  ...
  return (
    <section className="feed mb-20 max-w-">
      ...
      <div className='flex flex-wrap flex-contain'>
